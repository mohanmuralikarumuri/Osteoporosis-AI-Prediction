...
export default function ReportPredictor() {
  ...
  return (
    <div className="relative min-h-full">
      {/* 3-D bone background – violet/pink theme */}
      <BoneBackground
        accentColor="#8b5cf6"
        secondColor="#ec4899"
        gradientFrom="rgba(10,4,28,0.96)"
        gradientTo="rgba(20,5,36,0.96)"
        boneCount={14}
      />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        {/* ─── Results (independently scrollable on xl) ───────────────── */}
        <div id="report-results" className="xl:sticky xl:top-4 xl:max-h-[calc(100vh-8rem)] results-scroll space-y-4 pr-0.5">
